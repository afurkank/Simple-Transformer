...
def train(model: nn.Module, train_data: DataLoader, 
    ...
    for epoch in range(epoch_num):
        ...
        print(f'Training is complete for epoch {epoch:>2}, loss for epoch {epoch:>2}: {test_loss:>5.3f}')
